 ...
 * </p>
 * <p>
 * On a user-pool new user's can sign-up and create new {@link CognitoUserUtils}.
 */
public class CognitoUserPool {
    ...
    public CognitoSignup signUp(final String userId, final String password,
        ...
        try {
            ...
            CognitoUserUtils user = getUser(userId);
     ...
     *
     * @return An instance of the {@link CognitoUserUtils} for last authenticated, cached on this device
     */
    public CognitoUserUtils getCurrentUser() {
...
//        }
    ...
    /**
     * Returns a {@link CognitoUserUtils} with no username set.
     *
     * @return {@link CognitoUserUtils}.
     */
    public CognitoUserUtils getUser() {
        return new CognitoUserUtils(this, null, clientId, clientSecret, null, client);
    }

    /**
     * Returns a CognitoUser with userId {@code userId}
     * <p>
     * This CognitoUser is not authenticated. Call {@link CognitoUserUtils#getSession()}
     ...
     */
    public CognitoUserUtils getUser(String userId) {
        ...
        return new CognitoUserUtils(this, userId, clientId, clientSecret,
