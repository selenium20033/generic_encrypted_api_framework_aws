...
public class CognitoUserUtils {
     ...
     */
    protected CognitoUserUtils(CognitoUserPool pool, String userId,
    ...
    public CognitoUserCodeDeliveryDetails forgotPassword() {
        final CognitoUserUtils cognitoUser = this;
     ...
     * {@link CognitoUserUtils#getAttributeVerificationCode(String)}.
     * </p>
     *
